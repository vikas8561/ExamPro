...
import { Eye, EyeOff, IdCard, Lock, Loader2, AlertCircle } from 'lucide-react';

export default function Login() {
  // Students sign in with their 
  // UID or roll number; mentors and
  // admins use their email address. One field takes either.
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Handle lockout messages from server
          ...
          <div className="group">
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <IdCard className="h-5 w-5 text-gray-400 group-focus-within:text-white transition-colors" />
              </div>
              <input
                type="text"
                value={identifier}
                ...
                placeholder="Enter your UID or Roll No"
